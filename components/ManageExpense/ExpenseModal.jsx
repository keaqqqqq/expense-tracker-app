import { Dialog, DialogDescription, DialogPanel, DialogTitle, Input } from "@headlessui/react";
import Button from "./Button";
import FormInput from "../FormInput";
import SplitTab from "./SplitTab";
import CreateExpenseForm from "./CreateExpensesForm";

export default function ExpenseModal({ isOpen, closeModal }) {
    return (
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogPanel className="max-w rounded bg-white">
                    ...
                    <div className="px-5 py-2 flex flex-row font-semibold text-xs text-gray-700 border-b">
                        <div className="flex flex-col">within group <FormInput></FormInput></div>
                        <div className="flex flex-col">Add split <FormInput></FormInput></div>
                    </div>
